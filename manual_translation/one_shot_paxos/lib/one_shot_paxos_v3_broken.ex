  ...
  def accept_handler(acceptedProposal, acceptedValue, minProposal) do
    receive do
      ...
      {:accept, n, value, proposer} ->
        ...
        accept_handler(n, value, minProposal)
      {:terminate} ->
...
defmodule Learner3 do
  ...
  def start do
    ...
    acceptors = for _ <- 1..n_acceptors do
      spawn(Acceptor3, :start_acceptor, [])
    end

    for i <- 1..n_proposers do
      proposer = spawn(Proposer3, :start_proposer, [])
      val_i = i - 1
